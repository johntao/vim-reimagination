  ...
  public IList<CommandInfo> List
  {
    get
    {
      _list ??= [
        ...
        new(Cmd.Row_1unit_Back,  "Move 1 unit, Back , Row dir", 'j', 'h', () => _bm.Row(-1)),
        new(Cmd.Col_1unit_Forth, "Move 1 unit, Forth, Col dir", 'k', 't', () => _bm.Col(1)),
        new(Cmd.Col_1unit_Back,  "Move 1 unit, Back , Col dir", 'l', 'n', () => _bm.Col(-1)),
        new(Cmd.Row_1unit_Forth, "Move 1 unit, Forth, Row dir", ';', 's', () => _bm.Row(1)),
        new(Cmd.Row_FullScreen_Back_StopOnEdge,  "Move 1 full screen width , Back , Row dir, Stop on edge", 'J', 'H', () => _bm.RowStop(-_win.Width)),
        new(Cmd.Col_FullScreen_Forth_StopOnEdge, "Move 1 full screen height, Forth, Col dir, Stop on edge", 'K', 'T', () => _bm.Col(_win.Height)),
        new(Cmd.Col_FullScreen_Back_StopOnEdge,  "Move 1 full screen height, Back , Col dir, Stop on edge", 'L', 'N', () => _bm.Col(-_win.Height)),
        new(Cmd.Row_FullScreen_Forth_StopOnEdge, "Move 1 full screen width , Forth, Row dir, Stop on edge", ':', 'S', () => _bm.RowStop(_win.Width)),
